...
if __name__ == '__main__':
    ...
    print(test.keypair)
    box = test.create_box(test.encode_private_key(test.private_key), test.encode_public_key(test.public_key))
    message = 'hi my name is leanne'
    encrypted_message = test.encrypt_message(box, message)
    print('encrypted message:', encrypted_message)
    decrypt_message = test.decrypt_message(box, encrypted_message)
